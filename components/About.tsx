export default function(){
    return(
        <section className={`mt-40 mb-60 text-center text-lg md:pl-0`}>
            ...
            <p className='font-semibold  text-white leading-tight tracking-tighter xl:text-4xl md:text-xl sm:text-base flex justify-center'>
                Turning 
                ...
                into real life
                <div className="z-10 drop-shadow-lg shadow-white font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600">
                &nbsp;products&nbsp;
                </div>
                is my calling.  
            </p>
